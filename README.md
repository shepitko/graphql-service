...
type Mutation {
  ...
  createTrack(title: String!, albumId: ID, artistsIds: [ID], genresIds: [ID], bandsIds: [ID], duration: Int, released: Int): Track
  deleteTrack(id: ID!): Response
  updateTrack(id: ID!, title: String!, albumId: ID, artistsIds: [ID], genresIds: [ID], bandsIds: [ID], duration: Int, released: Int): Track
  ...
  updateAlbum(id: ID!, name: String, released: Int, artisstIds: [ID], bandsIds: [ID], tracksIds: [ID], genresIds: [ID], image: String): Album
